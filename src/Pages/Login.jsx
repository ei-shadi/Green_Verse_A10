    ...
    <>
      ...
      <div className="min-h-[calc(100vh-76px)] flex items-center justify-center w-11/12 mx-auto">
        <motion.div
          ...
          className="bg-gradient-to-t from-[#a3b18a] to-[#3a5a40] text-white p-8 rounded-xl shadow-2xl w-full max-w-lg"
        >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <button className="text-cyan-400 hover:text-amber-400" type="button">
                  Forget Password?
                </button>
              </div>
          ...
          <p className="text-lg text-center text-gray-300 my-5">
            ...
            <Link
              to="/auth/register"
              className="text-cyan-400 hover:text-amber-400 hover:border-b-2 border-amber-600 ml-1"
            >
              Register
            </Link>
          </p>
